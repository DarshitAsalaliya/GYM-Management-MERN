...
// Action
import { deleteSupplement } from '../../../Redux/actions/supplementAction';

export default memo(function DeleteSupplement(props) {
    ...
    const handleDelete = async () => {
        ...
        await dispatch(deleteSupplement(props.id));
